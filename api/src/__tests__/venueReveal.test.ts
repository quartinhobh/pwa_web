// Venue Reveal policy — pure-function tests.
...
import {
  ...
  policyFromLegacy,
  resolveVenueReveal,
} from '../services/venueReveal';
import type {
  VenueRevealContext,
  VenueRevealPolicy,
} from '../types';

const T = Date.UTC(2026, 4, 15); // 2026-05-15T00:00:00Z
...
describe('resolveVenueReveal', () => {
  it('legacy venueRevealDaysBefore=7 → days_before_event N=7', () => {
    ...
    expect(r.result.revealed).toBe(true); // nowMs - T = 0, daysUntil = 0 <= 7
  });
